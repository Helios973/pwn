# 堆概述 [¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-overview/#_1)

## 什么是堆 [¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-overview/#_2)
...
## 堆的基本操作 [¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-overview/#_3)
...
### malloc[¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-overview/#malloc)
...
### free[¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-overview/#free)
...
### 内存分配背后的系统调用 [¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-overview/#_4)
...
![img](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/figure/brk%26mmap.png)

#### (s)brk[¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-overview/#sbrk)
...
![img](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/figure/program_virtual_address_memory_space.png)
...
#### mmap[¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-overview/#mmap)
...
### 多线程支持 [¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-overview/#_5)
...
# 堆相关数据结构 [¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#_1)
...
## Overview[¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#overview)

> 待补充。

## 微观结构 [¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#_2)

这里首先介绍堆的一些主要内部结构，**堆的漏洞利用与这些结构密切相关**。

### malloc_chunk[¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#malloc_chunk)

#### 概述 [¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#_3)
...
- fd_nextsize， bk_nextsize
  ...
  空闲的时候才使用，不过其用于较大的 chunk（large chunk）。
...
#### chunk 相关宏 [¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#chunk)
...
### bin[¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#bin)

#### 概述 [¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#_4)
...
为了简化在双链接列表中的使用，每个 bin 的 header 都设置为 malloc_chunk 类型。这样可以避免 header 类型及其特殊处理。但是，为了节省空间和提高局部性，只分配 bin 的 fd/bk 指针，然后使用 repositioning tricks 将这些指针视为一个`malloc_chunk*`的字段。
...
#### Fast Bin[¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#fast-bin)
...
#### Small Bin[¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#small-bin)
...
#### Large Bin[¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#large-bin)
...
#### Unsorted Bin[¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#unsorted-bin)
...
#### common macro[¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#common-macro)
...
### Top Chunk[¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#top-chunk)
...
### last remainder[¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#last-remainder)
...
## 宏观结构 [¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#_5)

### arena[¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#arena)

在我们之前介绍的例子中，无论是主线程还是新创建的线程，在第一次申请内存时，都会有独立的 arena。那么会不会每个线程都有独立的 arena 呢？下面我们就具体介绍。

#### arena 数量 [¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#arena_1)
...
#### arena 分配规则 [¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#arena_2)

**待补充。**

#### 区别 [¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#_6)

与 thread 不同的是，main_arena 并不在申请的 heap 中，而是一个全局变量，在 libc.so 的数据段。

### heap_info[¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#heap_info)
...
### malloc_state[¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#malloc_state)
...
### malloc_par[¶](https://ctf-wiki.org/pwn/linux/user-mode/heap/ptmalloc2/heap-structure/#malloc_par)
